...
CS = digitalio.DigitalInOut(board.P9_18)
RESET = digitalio.DigitalInOut(board.P9_13)
#SCLK = digitalio.DigitalInOut(board.P9_22)
#MOSI = digitalio.DigitalInOut(board.P9_18)
#MISO = digitalio.DigitalInOut(board.P9_21)
...
print(board.MOSI)
print(board.MISO)
# = busio.SPI('P9_22', MOSI='P9_18', MISO='P9_21')
#spi = busio.SPI('P9_22', MOSI=SPI0_D1, MISO=SPI0_D0)
#spi = SPI(1,1)
